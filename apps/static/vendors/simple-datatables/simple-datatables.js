                  ...
                  (u = [
                    ...
                    function (t) {
                      ...
                      (this.zone || (this.zone = {})).offset =
                        ((n = t.match(/([+-]|\d\d)/g)), 0 == (e = 60 * n[1] + +n[2]) ? 0 : "+" === n[0] ? -e : e);
                    },
                  ]),
                  (h = {
                    A: [
      ...
      2: [
        function (require, module, exports) {
          ...
          class DataTable {
                    ...
                    this.options.plugins &&
                      Object.entries(this.options.plugins).forEach(([t, e]) => {
                        this[t] &&
                          ...
                          ((this[t] = this[t](e, { createElement: createElement })),
            ...
            render(t) {
              ...
              if (
                ...
                e.footer
                  ? this.head &&
                    !this.foot &&
                    ((this.foot = createElement("tfoot", { html: this.head.innerHTML })), this.table.appendChild(this.foot))
            ...
            renderPage() {
              if (
                (this.hasHeadings && (flush(this.header), this.activeHeadings.forEach((t) => this.header.appendChild(t))),
              ...
              if (
                (this.totalPages &&
                  ((a = (s = (e = this.currentPage - 1) * this.options.perPage) + this.pages[e].length),
                  (s += 1),
            ...
            renderPager() {
              if ((flush(this.pagers), this.totalPages > 1)) {
                ...
                this.options.truncatePager &&
                  (i = truncate(this.links, this.currentPage, this.pages.length, this.options.pagerDelta, this.options.ellipsisText)),
                ...
                if (((this.columnWidths = []), this.table.tHead)) {
                  if (
                    (this.options.scrollY.length &&
                      ((e = createElement("thead")).appendChild(createElement("tr")),
                      (e.style.height = "0px"),
                    ...
                    this.data.forEach((e, s) => {
                      ...
                      t.split(" ").reduce((t, s) => {
                        ...
                        for (let t = 0; t < e.cells.length; t++)
                          if (
                            (n = (i = e.cells[t]).hasAttribute("data-content") ? i.getAttribute("data-content") : i.textContent)
                              .toLowerCase()
                              .includes(s) &&
